...
class Registration extends MY_Controller {
	...
	public function save()
	{
		...
		$check_nik = $this->sitemodel->view('view_participants', '*', ['participant_nik'=>$participant_nik]);
		...
		# send email
		$subject = 'Registrasi HUT Metro TV 21';
		...
		$isSent = sendEmail($participant_email, $subject, $content, "Pendaftaran HUT Metro TV", $files);
